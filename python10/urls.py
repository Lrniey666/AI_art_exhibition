...
urlpatterns = [
    ...
    path('vehicle_growing_up_TN/', views.vehicle_growing_up_TN,name='vehicle_growing_up_TN'),
    path('vehicle_growing_up_TP/', views.vehicle_growing_up_TP,name='vehicle_growing_up_TP'),
    path('vehicle_growing_up_TY/', views.vehicle_growing_up_TY,name='vehicle_growing_up_TY' ),
    ...
    path('druck_butty/', views.druck_butty, name='druck_butty'),
    path('window_butty/', views.window_butty, name='window_butty'),
    path('TV_butty/', views.TV_butty, name='TV_butty'),
