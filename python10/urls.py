...
urlpatterns = [
    ...
    path('vehicle_growing_up_all/', views.vehicle_growing_up_all),
    ...
    path('Income_and_vehicle_all/', views.Income_and_vehicle_all),
    ...
    path('student_and_vehicle_car/', views.student_and_vehicle_car),
]
