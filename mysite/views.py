...
def druck_butty(request):

    return render(request, 'druck_butty.html')

def window_butty(request):

    return render(request, 'window_butty.html')

def TV_butty(request):

    return render(request, 'TV_butty.html')
